...
//    ScheduledThreadPool示例
    ...
    private static void scheduledThreadPoolTest1(){
        ...
        scheduledExecutorService.scheduleAtFixedRate(new RunnerTest(), 2, 3, TimeUnit.SECONDS);
...
//        RunnerTest.scheduledThreadPoolTest();
        RunnerTest.scheduledThreadPoolTest1();
//        RunnerTest.cachedThreadPoolTest();
//        RunnerTest.newSingleThreadExecutorTest();
    }
}
