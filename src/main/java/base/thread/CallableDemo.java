...
public class CallableDemo implements Callable<String> {
    ...
    public String call() throws InterruptedException {
        Date d = new Date();
        String str = d.toString() + Thread.currentThread();
        Thread.sleep(3000);
        return str;
    }
...
//        值得注意的是，Python中也是这样，在进程池中获取数据是一种危险的做法
//        所以语言为我们封装了接口来临时存储和获取多线程数据
    }
...
//        CallableDemo.completionServiceTest();
        CallableDemo.threadTest();
    }
